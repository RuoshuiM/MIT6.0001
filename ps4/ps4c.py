...
class SubMessage(object):
    ...
    def apply_transpose(self, transpose_dict):
        ...
        ciphertext = []
        for c in text:
            ciphertext.append(transpose_dict.get(c,c))
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        for perm in perms:
            ...
            attempts.append(message.apply_transpose(message.build_transpose_dict(perm)))
        return max(attempts, key=lambda x: len([word for word in x.split() if is_word(WORDS, word)]))
...
#    This is not working!
    message = SubMessage("Duck Dack Quack Quick Quoauk!")
    permutation = "oauei"
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Expected encryption:", "Dick Deck Qieck Qiuck Qiaeik!")
    print("Actual encryption:", message.apply_transpose(enc_dict))
    enc_message = EncryptedSubMessage(message.apply_transpose(enc_dict))
    print("Decrypted message:", enc_message.decrypt_message())